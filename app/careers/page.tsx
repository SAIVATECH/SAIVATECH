    ...
    <div className="min-h-screen pt-32 pb-24 px-6">
      <div className="max-w-4xl mx-auto">
         ...
         >
            ...
            <p className="text-slate-400 text-lg">We are always looking for high-agency individuals to help us build the next generation of automated internet infrastructure.</p>
         </motion.div>
               ...
               >
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center relative z-10 gap-6">
                     ...
                     <div className="shrink-0">
                        <a href={`https://wa.me/919442101823?text=${encodeURIComponent('Hello SaivaTech, I am interested in applying for the ' + job.title + ' role.')}`} target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-3 bg-white/5 hover:bg-[#00FFFF] border border-white/10 hover:border-[#00FFFF] text-white hover:text-black font-bold uppercase tracking-widest text-xs rounded-full transition-all duration-300">
                           Apply Now
                        </a>
                     </div>
                  </div>
