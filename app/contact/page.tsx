...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 px-6 flex items-center relative overflow-hidden isolate">
      {/* Background Orbs */}
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-[#00FFFF]/10 rounded-full blur-[120px] -z-10" />
      <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#00b8cc]/10 rounded-full blur-[150px] -z-10" />
      ...
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
         ...
         >
            ...
            <p className="text-slate-400 mb-8 text-sm relative z-10">Fill out this secure form mapping directly to our WhatsApp API to instantly speak with our engineers.</p>
            ...
            <form onSubmit={handleWhatsAppSubmit} className="relative z-10 flex flex-col gap-5">
               <div>
                  ...
                  <input required value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} type="text" className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#00FFFF]/50 transition-colors" placeholder="John Doe" />
               </div>
               <div>
               ...
               <div>
                  ...
                  <textarea required value={formData.message} onChange={e => setFormData({...formData, message: e.target.value})} rows={3} className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#00FFFF]/50 transition-colors resize-none" placeholder="Looking to build an automated funnel..." />
               </div>
