               ...
               >
                  <a href={project.liveLink} target="_blank" rel="noopener noreferrer" className="block relative w-full aspect-[4/3] rounded-3xl overflow-hidden glass-panel group-hover:border-[#00FFFF]/50 transition-all duration-700">
                     ...
                     <div className="absolute bottom-0 left-0 p-8 w-full">
                        ...
                        <p className="text-slate-400 line-clamp-2 mb-4 text-sm leading-relaxed">{project.description}</p>
                        
                        {/* Audit Recommendation: leader results show up for each project */}
                        <div className="text-[#00FFFF] font-mono text-xs border-b border-[#00FFFF]/30 inline-block pb-1 uppercase tracking-widest group-hover:border-[#00FFFF] transition-colors">
