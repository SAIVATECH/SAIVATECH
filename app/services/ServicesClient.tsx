    ...
    <div className="min-h-screen pt-32 pb-24">
            ...
            <div id={service.id} key={service.id} className="relative scroll-mt-32">
               ...
               <div className={`flex flex-col lg:flex-row gap-16 items-center ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                  ...
                  >
                     ...
                     <p className="text-slate-400 text-lg relative z-10 font-light">
                        {service.description}
                     </p>
                  </motion.div>
                  ...
                  <div className="w-full lg:w-1/2 flex flex-col space-y-8">
                     ...
                     >
                        <span className="text-red-400 font-mono text-xs mb-2 block uppercase tracking-widest font-bold">The Problem</span>
                     ...
                     >
                        <span className="text-[#00FFFF] font-mono text-xs mb-2 block uppercase tracking-widest font-bold">The Solution</span>
                     ...
                     >
                        <span className="text-green-400 font-mono text-xs mb-2 block uppercase tracking-widest font-bold">The Outcome</span>
                        <p className="text-white font-medium text-sm leading-relaxed">{service.outcome}</p>
                     </motion.div>
                     
                     <div className="pt-6">
                        <a href="https://wa.me/919442101823" className="text-[#00FFFF] hover:text-white font-mono text-sm tracking-widest uppercase transition-colors flex items-center gap-2 group font-semibold">
      ...
      <div className="mt-32 max-w-4xl mx-auto px-6 text-center">
         <div className="glass-panel rounded-3xl p-16 relative overflow-hidden">
            ...
            <p className="text-slate-400 mb-10 text-lg relative z-10 font-light">Software scales infinitely. Implement your automated system today.</p>
